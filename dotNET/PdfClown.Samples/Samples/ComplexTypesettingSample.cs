    ...
    public class ComplexTypesettingSample : Sample
    {
        ...
        private void BuildWelcomePage(Document document, FormXObject template)
        {
            ...
            */
            ...
            fonts::Font font = fonts::FontType0.Load(document, GetResourcePath("fonts" + Path.DirectorySeparatorChar + "lazyDog.ttf"));
        ...
        private FormXObject BuildTemplate(Document document, DateTime creationDate)
        {
            ...
            composer.BeginLocalState();
            {
                composer.SetFont(fonts::FontType1.Load(document, fonts::FontType1.FamilyEnum.Helvetica, false, false), 8);
