...
namespace PdfClown.Bytes
{
    ...
    */
    public interface IByteStream : IInputStream, IOutputStream
    {
        /**
        ...
        */
        ...
        IByteStream Extract(Filter filter, PdfDirectObject parameters, IDictionary<PdfName, PdfDirectObject> header);
        ...
        */
        Memory<byte> Encode(Filter filter, PdfDirectObject parameters, IDictionary<PdfName, PdfDirectObject> header);
