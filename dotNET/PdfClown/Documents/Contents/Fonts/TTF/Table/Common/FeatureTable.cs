...
namespace PdfClown.Documents.Contents.Fonts.TTF.Table.Common
{
    ...
    public class FeatureTable
    {
        ...
        private readonly int[] lookupListIndices;
        ...
        {
            get => lookupListIndices;
        }

        public override string ToString()
        {
            return $"FeatureTable[lookupListIndiciesCount={lookupListIndices.Length}]";
        }
    }
}
