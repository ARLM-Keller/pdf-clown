...
namespace PdfClown.Documents.Contents.Fonts.TTF.Table.Common
{
    ...
    public class LookupTable
    {
        ...
        private readonly LookupSubTable[] subTables;
        ...
        {
            return $"LookupTable[lookupType={lookupType},lookupFlag={lookupFlag},markFilteringSet={markFilteringSet}]";
        }
    }
}
