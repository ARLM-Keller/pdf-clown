...
namespace PdfClown.Documents.Encryption
{
     ...
     * X509Certificate2 certificate = (X509Certificate2)cf.generateCertificate(inStream);
     * inStream.close();
     *
    ...
    {
        private readonly List<PublicKeyRecipient> recipients = new List<PublicKeyRecipient>();
        private X509Certificate2 decryptionCertificate;
         ...
         */
        public IEnumerator<PublicKeyRecipient> RecipientsIterator
        {
            get => recipients.GetEnumerator();
        }
        ...
        {
            get => decryptionCertificate;
            set => decryptionCertificate = value;
        }
