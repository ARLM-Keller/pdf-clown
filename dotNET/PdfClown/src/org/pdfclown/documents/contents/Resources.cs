...
namespace org.pdfclown.documents.contents
{
    ...
    */
    ...
    public sealed class Resources : PdfObjectWrapper<PdfDictionary>, ICompositeDictionary<PdfName>
    {
        ...
        {
            get { return new ExtGStateResources(BaseDataObject.Get<PdfDictionary>(PdfName.ExtGState)); }
            set { BaseDataObject[PdfName.ExtGState] = value.BaseObject; }
        }

        public FontResources Fonts
        {
            get { return new FontResources(BaseDataObject.Get<PdfDictionary>(PdfName.Font)); }
            set { BaseDataObject[PdfName.Font] = value.BaseObject; }
        }

        public PatternResources Patterns
        {
            get { return new PatternResources(BaseDataObject.Get<PdfDictionary>(PdfName.Pattern)); }
        ...
        {
            get { return new PropertyListResources(BaseDataObject.Get<PdfDictionary>(PdfName.Properties)); }
            set
            {
        ...
        {
            get { return new ShadingResources(BaseDataObject.Get<PdfDictionary>(PdfName.Shading)); }
            set { BaseDataObject[PdfName.Shading] = value.BaseObject; }
        }

        public XObjectResources XObjects
        {
            get { return new XObjectResources(BaseDataObject.Get<PdfDictionary>(PdfName.XObject)); }
