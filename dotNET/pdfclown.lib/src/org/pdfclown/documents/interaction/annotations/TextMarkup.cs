    ...
    */
    ...
    public sealed class TextMarkup : Markup
    {
        ...
        */
        ...
        {
            get { return ToMarkupTypeEnum((PdfName)BaseDataObject[PdfName.Subtype]); }
            set
            {
        ...
        */
        private void RefreshAppearance()
        {
            ...
            SKRect box = org.pdfclown.objects.Rectangle.Wrap(BaseDataObject[PdfName.Rect]).ToRectangleF();
            {
