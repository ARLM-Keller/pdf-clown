      ...
      : PdfObjectWrapper<PdfDictionary>
    {
        ...
        */
        public SKRect Box
        {
            get
            {
                Rectangle box = Rectangle.Wrap(BaseDataObject[PdfName.R]);
            ...
            set
            {
                BaseDataObject[PdfName.R] = new Rectangle(
                  value.Left,
        ...
        */
        ...
        {
            get
            { return Wrap(BaseDataObject[PdfName.N]); }
        }
        ...
        */
        ...
        {
            get
            { return Wrap(BaseDataObject[PdfName.V]); }
        }
        #endregion
        #endregion
        #endregion
